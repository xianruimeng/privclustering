...
djn_text* djn_text_from_ui(unsigned long int x);

djn_cipher* djn_create_enc_zero();
...
/*
     ...
     */
void djn_mul(djn_pubkey_t* pub, djn_cipher* res, djn_cipher* ct0, djn_cipher* ct1);
    ...
    /*
      ...
      the modulus in pub.
     */
void djn_exp_neg(djn_pubkey_t* pub, djn_cipher* res, djn_cipher* ct, djn_text* pt) ;
    ...
    /*
            ...
            assumed to have already been allocated.
     */
void djn_sub(djn_pubkey_t* pub, djn_cipher* res, djn_cipher* ct0, djn_cipher* ct1);
    ...
    /*
      ...
      the modulus in pub.
     */
void djn_exp(djn_pubkey_t* pub, djn_cipher* res, djn_cipher* ct, djn_text* pt);
