...
*/
void
paillier_exp_neg(djn_pubkey_t* pub,
        djn_cipher* res,
        djn_cipher* ct,
        djn_text* pt) {
 ...
 * @param ct1
 */
void paillier_sub(djn_pubkey_t* pub, 
			djn_cipher* res, 
			djn_cipher* ct0, 
			djn_cipher* ct1){
...
djn_text*
djn_text_from_ui(unsigned int x) {
    djn_text* pt;

    pt = (djn_text*) malloc(sizeof (djn_text));
...
djn_create_enc_zero() {
    ...
    ct = (djn_cipher*) malloc(sizeof (djn_cipher));
